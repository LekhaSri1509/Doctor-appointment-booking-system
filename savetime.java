...
public class savetime extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Servlet savetime</title>");  
            out.println("<style>");
            ...
            String text=request.getParameter("sym");
            savetimemodel m1=new savetimemodel();
            m1.connectionjdbc(time, docid, text, date);
